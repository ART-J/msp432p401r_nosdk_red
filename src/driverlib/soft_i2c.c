...
#define I2C_SDA_SET()   P1DIR &=~BIT6
#define I2C_SDA_CLR()   P1DIR |= BIT6
#define I2C_SDA_IN()    P1IN  &  BIT6
#define I2C_SCL_SET()   P1DIR &=~BIT7
#define I2C_SCL_CLR()   P1DIR |= BIT7

#define CPU_FREQ  48000000

static inline void delay_us(void)
{
	__delay_cycles(CPU_FREQ /4000000);
}
