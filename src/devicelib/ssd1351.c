...
#define SSD1351_PIN_SET()	P10DIR |= BIT3; P10DIR |= BIT4; P10DIR |= BIT5

#define SSD1351_RES_SET()	P10OUT |= BIT3
#define SSD1351_RES_CLR()	P10OUT &=~BIT3
#define SSD1351_DC_SET()	P10OUT |= BIT4
#define SSD1351_DC_CLR()	P10OUT &=~BIT4
#define SSD1351_CS_SET()	P10OUT |= BIT5
#define SSD1351_CS_CLR()	P10OUT &=~BIT5

#define SSD1351_WRITE_BYTE(__DATA)	usci_b3_spi_transmit_frame(&__DATA, 1)
